...
alter table public.tournaments
  ...
  add constraint tournaments_first_throw_mode_check
    check (first_throw_mode is null or first_throw_mode in ('alternate', 'winner'));
...
set first_throw_mode = t.first_throw_mode
from public.tournaments t
where t.id = m.tournament_id
  and m.first_throw_mode is null
  and t.first_throw_mode is not null;
